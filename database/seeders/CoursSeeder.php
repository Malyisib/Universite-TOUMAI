...
class CoursSeeder extends Seeder
{
    ...
    private function getWeeklySchedule(string $matiere): array
    {
        ...
        $subjectSchedules = [
            'Architecture des Ordinateurs' => ['sessions' => 3, 'duration' => 2],
            'Technologie Web' => ['sessions' => 3, 'duration' => 2],
            'Anglais' => ['sessions' => 2, 'duration' => 2],
            'Base de données' => ['sessions' => 2, 'duration' => 2],
            'Télécommunication' => ['sessions' => 2, 'duration' => 1.5],
            'Administration Système et Réseaux' => ['sessions' => 2, 'duration' => 2],
            'Sécurité Réseaux' => ['sessions' => 1, 'duration' => 2],
        ];
