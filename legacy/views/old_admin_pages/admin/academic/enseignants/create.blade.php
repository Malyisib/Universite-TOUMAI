...
<div class="google-container">
                ...
                <div class="google-form-row">
                    ...
                    <div class="google-form-group">
                        ...
                        <input type="email" class="google-input @error('email') is-invalid @enderror" 
                               ...
                               placeholder="exemple@toumai.com">
                        @error('email')
                            <span class="google-error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="google-form-group">
                        ...
                        <select class="google-input @error('matiere') is-invalid @enderror" 
                            ...
                            <option value="Architecture des ordinateurs" {{ old('matiere') == 'Architecture des ordinateurs' ? 'selected' : '' }}>Architecture des ordinateurs</option>
                            <option value="Base de données" {{ old('matiere') == 'Base de données' ? 'selected' : '' }}>Base de données</option>
                            <option value="Anglais" {{ old('matiere') == 'Anglais' ? 'selected' : '' }}>Anglais</option>
                            <option value="Administration système et reseau" {{ old('matiere') == 'Administration système et reseau' ? 'selected' : '' }}>Administration système et reseau</option>
                            <option value="Telecommunication" {{ old('matiere') == 'Telecommunication' ? 'selected' : '' }}>Telecommunication</option>
                            <option value="Programmation Python" {{ old('matiere') == 'Programmation Python' ? 'selected' : '' }}>Programmation Python</option>
    ...
    <script>
        ...
        const matiereOptions = {
            ...
            2: ["اللغة العربية", "Calcule", "Base de données", "Telecommunication", "التربية الإسلامية", "التربية المدنية",
                "التاريخ و الجغرافيا"
            ],
            3: ["اللغة العربية", "Calcule", "Base de données", "Telecommunication", "التربية الإسلامية", "التربية المدنية",
                "التاريخ و الجغرافيا"
            ],
            4: ["اللغة العربية", "Calcule", "Base de données", "Telecommunication", "التربية الإسلامية", "التربية المدنية",
                "التاريخ و الجغرافيا"
            ],
            5: ["اللغة العربية", "Calcule", "Base de données", "Telecommunication", "التربية الإسلامية", "التربية المدنية",
                "التاريخ و الجغرافيا"
            ],
            6: ["Architecture des ordinateurs","اللغة العربية", "Base de données", "Telecommunication", "التربية الإسلامية", "التربية المدنية",
                "التاريخ و الجغرافيا"
            ],
            7: ["Architecture des ordinateurs","Base de données", "Anglais", "التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication",
                "التاريخ و الجغرافيا", "التربية المدنية"
            ],
            8: ["Architecture des ordinateurs","Base de données", "Anglais", "التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication",
                "التاريخ و الجغرافيا", "التربية المدنية"
            ],
            9: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication",
                "التاريخ و الجغرافيا", "التربية المدنية"
            ],
            10: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication",
                "التاريخ و الجغرافيا", "التربية المدنية"
            ],
            11: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "التربية المدنية", "اللغة العربية", "Administration système et reseau", "Telecommunication"],
            12: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "التربية المدنية", "اللغة العربية", "Administration système et reseau", "Telecommunication"],
            13: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication"],
            14: ["Architecture des ordinateurs","Base de données", "Anglais","التربية الإسلامية", "اللغة العربية", "Administration système et reseau", "Telecommunication"],
        };
