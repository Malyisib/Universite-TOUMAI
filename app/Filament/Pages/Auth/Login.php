...
class Login extends BaseLogin
{
    public function mount(): void
    {
        ...
        $defaults = [
            'admin' => ['email' => 'admin@toumai.com', 'password' => 'admin123'],
            'staff' => ['email' => 'gestionnaire@toumai.com', 'password' => 'gestionnaire123'],
            'teacher' => ['email' => 'cherif@toumai.com', 'password' => 'enseignant123'],
        ];
    ...
    protected function determinePanelRole(): string
    {
        ...
        $path = request()->path();
        if (Str::contains($path, ['staff', 'gestionnaire'])) {
            return 'staff';
        }
