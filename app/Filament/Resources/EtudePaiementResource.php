                ...
                Forms\Components\Section::make('Payment Information')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('montant')
                            ...
                            ->required()
                            ->numeric()
                            ->prefix(config('app.currency', 'XAF'))
                            ->minValue(0)
                            ->default(0.00),
                    ])
                    ->columns(3),
                ...
                Forms\Components\Section::make(__('app.payment_summary'))
                    ...
                    ->schema([
                        ...
                        Forms\Components\Placeholder::make('montant_display')
                            ->label(__('app.montant'))
                            ->content(fn ($record) => new \Illuminate\Support\HtmlString('<span class="text-lg font-semibold text-green-600">' . config('app.currency', 'XAF') . ' ' . number_format($record->montant, 2) . '</span>')),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('montant')
                    ->label(__('app.montant'))
                    ->money(config('app.currency', 'XAF'),locale: 'en')
                    ->sortable()
                    ->summarize([
