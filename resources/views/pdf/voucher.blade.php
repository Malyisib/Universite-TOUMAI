...
<body>
    <div class="voucher-container">
        <div class="header">
            ...
            <div class="school-name">Université Toumai</div>
        ...
        <div class="voucher-body">
            ...
            <div class="notes-section">
                ...
                <div class="notes-content">
                    Ce justificatif confirme que le paiement ci-dessus a été traité avec succès le {{ $payment->date_paiement->format('F j, Y') }}. 
                    Le montant a été transféré sur le compte désigné de l'employé.
                </div>
            </div>
            ...
            <div class="signature-section">
                ...
                <div class="signature-box">
                    <div class="signature-line"></div>
                    <div class="signature-label">AUTORISÉ PAR</div>
                </div>
            </div>
        </div>
        
        <div class="footer">
            <p><strong>Université Toumai</strong> - Département des Ressources Humains</p>
            <p>Ceci est un justificatif généré par ordinateur. En cas de divergence, veuillez contacter immédiatement les ressources humaines (RH).</p>
            <p>Tel: +235 00 00 00 00 | Email: rh@toumai.com</p>
        </div>
    </div>
</body>
</html>